...
#define CC_CH_CERT_MODULE_ERROR_BASE  (CC_ERROR_BASE + \
                                          (CC_ERROR_LAYER_RANGE * CC_LAYER_ERROR_IDX) + \
                                          (CC_ERROR_MODULE_RANGE * CH_CERT_ERROR_IDX ) )
...
#define CC_TRNG_MODULE_ERROR_BASE    (CC_ERROR_BASE + \
                                     (CC_ERROR_LAYER_RANGE * LLF_LAYER_ERROR_IDX) + \
                                     (CC_ERROR_MODULE_RANGE * TRNG_ERROR_IDX ) )

/*! The error base address of the SM3 module - 0x00F03000. */
#define CC_SM3_MODULE_ERROR_BASE (CC_ERROR_BASE + \
                                           (CC_ERROR_LAYER_RANGE * CC_LAYER_ERROR_IDX) + \
                                           (CC_ERROR_MODULE_RANGE * SM3_ERROR_IDX ) )

/*! The error base address of the SM4 module - 0x00F03100. */
#define CC_SM4_MODULE_ERROR_BASE  (CC_ERROR_BASE + \
                                         (CC_ERROR_LAYER_RANGE * CC_LAYER_ERROR_IDX) + \
                                         (CC_ERROR_MODULE_RANGE * SM4_ERROR_IDX ) )

/*! The error base address of the CPP  module - 0x00F03200. */
#define CC_CPP_MODULE_ERROR_BASE  (CC_ERROR_BASE + \
                                         (CC_ERROR_LAYER_RANGE * CC_LAYER_ERROR_IDX) + \
