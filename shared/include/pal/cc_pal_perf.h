...
typedef enum
{
    ...
    PERF_TEST_TYPE_CC_SM3_INIT,
    PERF_TEST_TYPE_CC_SM3_UPDATE,
    PERF_TEST_TYPE_CC_SM3_FIN,
...
static char* CC_PalPerfTypeStr(CCPalPerfType_t type, char* pStr, uint32_t buffLen)
{
    ...
    switch (type)
    {
        ...
        CCPalPerfTypeStr_str(PERF_TEST_TYPE_CC_SM3_INIT);
        CCPalPerfTypeStr_str(PERF_TEST_TYPE_CC_SM3_UPDATE);
        CCPalPerfTypeStr_str(PERF_TEST_TYPE_CC_SM3_FIN);
