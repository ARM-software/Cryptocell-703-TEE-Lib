...
#define CC_PAL_MAX_LOG_LEVEL  CC_PAL_LOG_LEVEL_DEBUG /*CC_PAL_LOG_LEVEL_DEBUG*/
...
#define _CC_PAL_LOG(level, format, ...)  \
    if (CC_PAL_logMask & CC_PAL_LOG_CUR_COMPONENT) \
        CC_PalLog(CC_PAL_LOG_LEVEL_ ## level, "%s:%s:%d " format, CC_PAL_LOG_CUR_COMPONENT_NAME, __func__,__LINE__, ##__VA_ARGS__)
