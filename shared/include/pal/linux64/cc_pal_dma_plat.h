...
#error "unknown HW"
#endif
#define PAL_WORKSPACE_MEM_SIZE          0x01000000	/* 16MB */
...
/**
 * @brief   Initializes contiguous memory pool required for CC_PalDmaContigBufferAllocate() and CC_PalDmaContigBufferFree().
 *
