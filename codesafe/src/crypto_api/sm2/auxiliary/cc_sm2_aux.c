...
)
{
    ...
    CC_CommonReverseMemcpy( working_buffer + 2 + idlen + 3 * modSizeInBytes +   ordSizeInBytes,    (uint8_t*)pPubKey->x, ordSizeInBytes);
    CC_CommonReverseMemcpy( working_buffer + 2 + idlen + 3 * modSizeInBytes + 2*ordSizeInBytes,    (uint8_t*)pPubKey->y, ordSizeInBytes);
