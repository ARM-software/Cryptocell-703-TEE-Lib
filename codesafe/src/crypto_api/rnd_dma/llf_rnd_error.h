...
#define LLF_RND_TRNG_EHR_DATA_ZERO_ERROR                (LLF_RND_MODULE_ERROR_BASE + 0x22UL)
...
#define LLF_RND_TRNG_BUFFER_TOO_SMALL_ERROR             (LLF_RND_MODULE_ERROR_BASE + 0x38UL)
#define LLF_RND_WORKSPACE_TOO_SMALL_ERROR             (LLF_RND_MODULE_ERROR_BASE + 0x39UL)
#define LLF_RND_CC_FATAL_ERROR                              (LLF_RND_MODULE_ERROR_BASE + 0x3AUL)
#define LLF_RND_MISSING_ROSC_ERROR                      (LLF_RND_MODULE_ERROR_BASE + 0x3BUL)
