...
#define LLF_RND_HW_EHR_SAMPLES_ON_FE_MODE  1UL
#define LLF_RND_HW_SAMPLES_NUM_ON_FE_MODE  (LLF_RND_HW_EHR_SAMPLES_ON_FE_MODE*2) /*  for both AES128 and AES256 */
...
#define LLF_RNG_INT_MASK_ON_FETRNG_MODE  0xFFFFFFE0
