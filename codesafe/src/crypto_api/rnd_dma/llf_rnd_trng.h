 ...
 * @param[in/out] pTrngParams - The pointer to structure, containing TRNG parameters.
 ...
 * @param[in/out] - pTrngWorkBuff - The pointer to the temp buffer for allocation of
 *      			   estimator buffers.
 ...
 *
 * @param[in/out] rndContext_ptr - The pointer to the internal State buffer of DRNG.
 * @param[out] pTrngParams - The pointer to structure, containing TRNG parameters.
 * @param[in/out] - pTrngWorkBuff - The pointer to the temp buffer for allocation of
 *      			   estimator buffers.
 *
 * @return CCError_t - On success CC_OK is returned, on failure a
...
CCError_t LLF_RND_RunTrngStartupTest(
        CCTrngState_t *pTrngState,	/*in/out*/
        CCTrngParams_t *pTrngParams,   /*out*/
        uint32_t          *pTrngWorkBuff);	/*in*/
