...
/**
  ...
  @param p_rng [in,out] - Pointer to the random context - the input to f_rng.
                                                    ...
                                                    uint8_t  *rndVect_ptr )
{
	...
	if (rndSizeInBits > 0x7FFFF)
        ...
        if (maxVect_ptr == NULL) {
                ...
                Error = f_rng((void *)p_rng, (unsigned char *)rndVect_ptr, (size_t)rndSizeInBytes);
        ...
        while (k < 0xFFFF) {
                ...
                Error = f_rng((void *)p_rng, (unsigned char *)rndVect_ptr, (size_t)maxVectSizeBytes);
