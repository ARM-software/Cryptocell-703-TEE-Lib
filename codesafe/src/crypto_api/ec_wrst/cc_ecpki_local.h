...
*/
#define EcdsaSignFinish(pSignUserContext, f_rng, p_rng, pSignatureOut, pSignatureOutSize) \
EcdsaSignFinishInt((pSignUserContext), (f_rng), (p_rng), (pSignatureOut), (pSignatureOutSize), 1, NULL)
