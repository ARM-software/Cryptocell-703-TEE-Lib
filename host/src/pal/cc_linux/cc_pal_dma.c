...
#ifndef MEMORY_FRAGMENT_MAX_SIZE_IN_KB
#error "missing MEMORY_FRAGMENT_MAX_SIZE_IN_KB definition"
#endif

#if MEMORY_FRAGMENT_MAX_SIZE_IN_KB == 0
#error "MEMORY_FRAGMENT_MAX_SIZE_IN_KB invalid value"
#endif

#define PAL_PAGE_SHIFT      PalCalcPageShift(MEMORY_FRAGMENT_MAX_SIZE_IN_KB)
#define PAL_PAGE_SIZE       ((size_t)(1 << PAL_PAGE_SHIFT))
