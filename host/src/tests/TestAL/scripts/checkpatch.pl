...
#urishir	my @tree_check = (
#urishir		"COPYING", "CREDITS", "Kbuild", "MAINTAINERS", "Makefile",
#urishir		"README", "Documentation", "arch", "include", "drivers",
#urishir		"fs", "init", "ipc", "kernel", "lib", "scripts",
#urishir	);
